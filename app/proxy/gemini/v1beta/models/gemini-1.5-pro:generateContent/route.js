...
const TARGET_SERVER_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent';
...
export async function POST(request) {
    ...
    // const apiKey = headersList.get('x-goog-api-key') || API_KEY;
